	...
	<aside class="sidebar-nav-wrapper">
		...
		<nav class="sidebar-nav">
			<ul>
                ...
                <li class="nav-item nav-item-has-children">
                    <a data-bs-toggle="collapse" data-bs-target="#c_menu_1"
						aria-controls="c_menu_1" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
								xmlns="http://www.w3.org/2000/svg">
								<path
                    ...
                    <ul id="c_menu_1" class="collapse dropdown-nav">
                        <li>
						...
						<li>
                            <router-link to="/reference-list">reference</router-link>
                        </li>
						<li>
				...
				<li class="nav-item nav-item-has-children">
					...
					<ul id="ddmenu_3" class="collapse dropdown-nav">
						<li>
							<router-link to="/user">User & User Role</router-link>
						</li>
						<li>
							<router-link to="/role">Role & Role Url_Repository</router-link>
						</li>
						<li>
							<router-link to="/url-repository">Url_Repository</router-link>
						</li>
						<li>
				...
				<li class="nav-item nav-item-has-children">
					...
					<ul id="ddmenu_5" class="collapse dropdown-nav">
						<li>
							<a href="form-elements.html"> From Template </a>
						</li>
						<li>
				...
				<li class="nav-item nav-item-has-children">
					<a href="#0" class="collapsed" data-bs-toggle="collapse" data-bs-target="#Template"
						aria-controls="ddmenu_5" aria-expanded="false" aria-label="Toggle navigation">
						<span class="icon">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none"
								xmlns="http://www.w3.org/2000/svg">
					...
					<ul id="Template" class="collapse dropdown-nav">
						<li>
							<router-link to="/grid">AgGrid</router-link>
						</li>
						<li>
							<router-link to="/scheduleX">Schedule-X</router-link>
						</li>
						<li>
							<router-link to="/full-calendar">Full Calendar</router-link>
						</li>
						<li>
